...
![Version](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.github.com%2Frepos%2Fmatter-js%2Fmatterjs-server%2Freleases%2Flatest&query=%24.name&label=Version)![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.github.com%2Frepos%2Fmatter-js%2Fmatterjs-server%2Freleases%2Flatest&query=%24.name&label=Version)

matterjs-server Helm chart for Kubernetes

### Installing the Chart
To install the chart with the release name my-release:

```
helm install my-release oci://ghcr.io/hobbit44/matterjs-server-helm/matterjs-server
```
...
* <https://github.com/hobbit44/matterjs-server-helm>
...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| config | object | `{}` | Pocket-id configuration variables For more information see: https://github.com/matter-js/matterjs-server/blob/main/docs/docker.md#environment-variables |
...
| image.repository | string | `"ghcr.io/matter-js/matterjs-server"` | The container image to run |
| image.tag | string | `"stable"` | Overrides the image tag whose default is the chart version. |
